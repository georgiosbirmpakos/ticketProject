...
export default function EventDetailsPage() {
  ...
  return (
    ...
    <Box
      ...
      <Typography sx={{color:'black', fontSize:'small', marginLeft:2, 
      ...
      <Typography sx={{color:'black', fontSize:'x-large', marginLeft:2, fontWeight:'bolder',clear:'both' ,
      ...
      <div ref={myRef}>
      <Typography sx={{color:'black', fontSize:'x-large', marginLeft:2, fontWeight:'bolder',clear:'both' ,
          float:'left', display:'block'}}>ΕΙΣΙΤΗΡΙΑ</Typography>
      <Divider variant="middle" style={{marginBottom:10, marginTop:10, clear:'both'}} />
      </div>
